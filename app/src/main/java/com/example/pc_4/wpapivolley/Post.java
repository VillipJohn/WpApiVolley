package com.example.pc_4.wpapivolley;
...
//        String url = "http://www.anekdotabc.com.ua//wp-json/posts/"+id+"?fields=title,content";
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String s) {
                ...
                content.loadData(mapContent.get("rendered").toString(),"text/html","ANSI");
